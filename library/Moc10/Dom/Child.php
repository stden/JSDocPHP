...
class Moc10_Dom_Child extends Moc10_Dom_Abstract
{
     ...
     *
     * @param  array $c
     * @return Moc10_Dom_Child
     */
    static public function factory(array $c)
    {
        ...
        $child = new Moc10_Dom_Child($nodeName, $nodeValue, null, $childFirst, $indent);
